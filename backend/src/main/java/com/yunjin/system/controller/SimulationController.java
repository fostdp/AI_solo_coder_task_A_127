...
import com.yunjin.system.service.WeavingSimulationService;
...
public class SimulationController {
    ...
    private final WeavingSimulationService simulationService;
    private final WebSocketService webSocketService;

    public SimulationController(WeavingSimulationService simulationService,
    ...
    public ResponseEntity<Map<String, Object>> init(@PathVariable Long loomId) {
        try {
            ...
            webSocketService.broadcastSimulationUpdate(loomId, state);
    ...
    public ResponseEntity<Map<String, Object>> step(
        ...
        try {
            ...
            if (body != null && body.containsKey("shedOpening")) {
                ...
                int warpCount = 120;
                try {
                    WeavingSimulation existing = simulationService.initSimulation(loomId);
