...
import com.yunjin.system.service.FabricAnalysisService;
...
public class FabricAnalysisController {
    ...
    private final FabricAnalysisService analysisService;

    public FabricAnalysisController(FabricAnalysisService analysisService) {
